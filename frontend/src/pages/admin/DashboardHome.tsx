        ...
        <div className="space-y-8">
            ...
            <div>
                <div className="flex justify-between items-center mb-6">
                    ...
                    <Link to={`${basePath}/add-book`} className="bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors shadow-sm">
                        <Plus size={18} />
